...
def create_record():
    ...
    services_df.to_csv("src/data/db/services.csv", index=False)
    devices_df.to_csv("src/data/db/devices.csv", index=False)
    records_df.to_csv("src/data/db/records.csv", index=False)
